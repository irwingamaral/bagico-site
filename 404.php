...
<style>
  ...
  .error-title{font-family:var(--serif);font-size:clamp(32px,4vw,56px);font-weight:300;color:var(--ivory);margin-bottom:20px;opacity:0;animation:fadeUp .8s ease .3s forwards;}
  .error-title em{font-style:italic;color:var(--ash);}
  .error-sub{font-size:15px;color:var(--ash);line-height:1.8;max-width:480px;margin:0 auto 48px;opacity:0;animation:fadeUp .8s ease .5s forwards;}
