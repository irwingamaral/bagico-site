...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero-proof { font-size: 13px; color: var(--ash); opacity: 0; font-style: italic; font-family: var(--serif); margin-bottom: 52px; animation: fadeUp 0.8s ease 0.7s forwards; }
  ...
  /* PLATAFORMAS */
  .plataformas { padding: 80px 60px; background: var(--carbon); border-top: 1px solid var(--graphite); border-bottom: 1px solid var(--graphite); }
  .plataformas-label { font-size: 10px; letter-spacing: 0.25em; text-transform: uppercase; color: var(--ash); margin-bottom: 40px; opacity: 0.6; }
  .plataformas-grid { display: grid; grid-template-columns: repeat(5, 1fr); gap: 1px; background: var(--graphite); }
  .plataforma-item { background: var(--carbon); padding: 32px 24px; text-align: center; transition: background 0.3s; }
  .plataforma-item:hover { background: var(--graphite); }
  .plataforma-nome { font-family: var(--serif); font-size: 18px; font-weight: 400; color: var(--ivory); margin-bottom: 6px; }
  .plataforma-tipo { font-size: 10px; letter-spacing: 0.12em; text-transform: uppercase; color: var(--ash); opacity: 0.6; }
  ...
  .como-item { display: grid; grid-template-columns: 48px 1fr; gap: 24px; padding: 36px 0; border-bottom: 1px solid var(--graphite); align-items: start; }
  .como-item:first-child { border-top: 1px solid var(--graphite); }
  .como-num { font-family: var(--serif); font-size: 13px; color: var(--desire); margin-top: 4px; }
  .como-title { font-family: var(--serif); font-size: 20px; font-weight: 400; color: var(--ivory); margin-bottom: 8px; }
  .como-desc { font-size: 13px; color: var(--ash); line-height: 1.8; }
  .como-right { display: flex; flex-direction: column; gap: 24px; }
  .resultado-card { border: 1px solid var(--graphite); padding: 36px 32px; position: relative; overflow: hidden; }
  .resultado-card::before { content: ''; position: absolute; top: 0; left: 0; width: 2px; height: 100%; background: var(--desire); }
  .resultado-num { font-family: var(--serif); font-size: 52px; font-weight: 300; color: var(--ivory); line-height: 1; margin-bottom: 8px; }
  .resultado-num span { color: var(--desire); }
  .resultado-desc { font-size: 13px; color: var(--ash); line-height: 1.6; }

  /* SERVICOS INCLUSOS */
  .servicos { padding: 120px 60px; background: var(--carbon); }
  .servicos-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px; margin-top: 64px; }
  .servico-card { border: 1px solid var(--graphite); padding: 40px 32px; transition: border-color 0.3s; }
  ...
  .servico-title { font-family: var(--serif); font-size: 20px; font-weight: 400; color: var(--ivory); margin-bottom: 12px; }
  .servico-desc { font-size: 13px; color: var(--ash); line-height: 1.8; }
