...
<link rel="canonical" href="https://www.bagico.com.br/trafego">
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero-title { font-family: var(--serif); font-size: clamp(52px, 8vw, 110px); font-weight: 300; line-height: 0.92; color: var(--text-primary); margin-bottom: 32px; opacity: 0; animation: fadeUp 0.8s ease 0.4s forwards; }
  .hero-title em { font-style: italic; color: var(--text-secondary); }
  .hero-title .dot { color: var(--desire); }
  .hero-sub { font-size: 16px; color: var(--text-secondary); line-height: 1.8; max-width: 520px; margin-bottom: 16px; opacity: 0; animation: fadeUp 0.8s ease 0.6s forwards; }
  .hero-proof { font-size: 13px; color: var(--text-secondary); opacity: 0; font-style: italic; font-family: var(--serif); margin-bottom: 52px; animation: fadeUp 0.8s ease 0.7s forwards; }
  .hero-actions { display: flex; align-items: center; gap: 24px; opacity: 0; animation: fadeUp 0.8s ease 0.8s forwards; flex-wrap: wrap; }
  .btn-primary { background: var(--desire); color: var(--text-primary); text-decoration: none; font-size: 12px; letter-spacing: 0.15em; text-transform: uppercase; padding: 16px 36px; transition: background 0.3s, transform 0.2s; display: inline-block; }
  .btn-primary:hover { background: var(--ember); transform: translateY(-1px); }
  .btn-secondary { color: var(--text-secondary); text-decoration: none; font-size: 12px; letter-spacing: 0.15em; text-transform: uppercase; border: 1px solid var(--border); padding: 16px 28px; transition: color 0.3s, border-color 0.3s; }
  .btn-secondary:hover { color: var(--text-primary); border-color: var(--text-secondary); }

  /* PLATAFORMAS */
  .plataformas { padding: 80px 60px; background: var(--surface); border-top: 1px solid var(--border); border-bottom: 1px solid var(--border); }
  .plataformas-label { font-size: 10px; letter-spacing: 0.25em; text-transform: uppercase; color: var(--text-secondary); margin-bottom: 40px; opacity: 0.6; }
  .plataformas-grid { display: grid; grid-template-columns: repeat(5, 1fr); gap: 1px; background: var(--graphite); }
  .plataforma-item { background: var(--surface); padding: 32px 24px; text-align: center; transition: background 0.3s; }
  .plataforma-item:hover { background: var(--graphite); }
  .plataforma-nome { font-family: var(--serif); font-size: 18px; font-weight: 400; color: var(--text-primary); margin-bottom: 6px; }
  ...
  .como-item { display: grid; grid-template-columns: 48px 1fr; gap: 24px; padding: 36px 0; border-bottom: 1px solid var(--border); align-items: start; }
  .como-item:first-child { border-top: 1px solid var(--border); }
  .como-num { font-family: var(--serif); font-size: 13px; color: var(--desire); margin-top: 4px; }
  .como-title { font-family: var(--serif); font-size: 20px; font-weight: 400; color: var(--text-primary); margin-bottom: 8px; }
  .como-desc { font-size: 13px; color: var(--text-secondary); line-height: 1.8; }
  .como-right { display: flex; flex-direction: column; gap: 24px; }
  .resultado-card { border: 1px solid var(--border); padding: 36px 32px; position: relative; overflow: hidden; }
  .resultado-card::before { content: ''; position: absolute; top: 0; left: 0; width: 2px; height: 100%; background: var(--desire); }
  .resultado-num { font-family: var(--serif); font-size: 52px; font-weight: 300; color: var(--text-primary); line-height: 1; margin-bottom: 8px; }
  .resultado-num span { color: var(--desire); }
  ...
  .servico-icon-line { width: 32px; height: 1px; background: var(--desire); margin-bottom: 24px; }
  .servico-title { font-family: var(--serif); font-size: 20px; font-weight: 400; color: var(--text-primary); margin-bottom: 12px; }
  ...
  .faq-q-text { font-family: var(--serif); font-size: 20px; font-weight: 400; color: var(--text-primary); }
  .faq-icon { color: var(--desire); font-size: 20px; transition: transform 0.3s; flex-shrink: 0; margin-left: 24px; }
  .faq-item.open .faq-icon { transform: rotate(45deg); }
  .faq-answer { font-size: 14px; color: var(--text-secondary); line-height: 1.9; max-height: 0; overflow: hidden; transition: max-height 0.4s ease, padding 0.3s ease; }
  ...
  footer { padding: 48px 60px; border-top: 1px solid var(--border); display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 24px; }
...
<nav aria-label="Menu BagiCo">
  ...
  <div class="nav-actions">
    ...
    <a href="https://wa.me/5551993535790?text=Ol%C3%A1%21%20Vim%20pela%20p%C3%A1gina%20de%20Tr%C3%A1fego%20Pago%20e%20quero%20saber%20mais%20sobre%20esse%20servi%C3%A7o." target="_blank" class="nav-cta">Fale conosco</a>
  </div>
<!-- MENU MOBILE -->
...
<div class="mobile-menu" id="mobileMenu">
  ...
  <a href="https://wa.me/5551993535790?text=Ol%C3%A1%21%20Vim%20pela%20p%C3%A1gina%20de%20Tr%C3%A1fego%20Pago%20e%20quero%20saber%20mais%20sobre%20esse%20servi%C3%A7o." target="_blank" class="mobile-cta">Fale conosco</a>
</div>
</nav>
...
<section class="hero" aria-label="Tráfego pago BagiCo Porto Alegre">
  ...
  <div class="hero-content">
    ...
    <div class="hero-actions">
      <a href="https://wa.me/5551993535790?text=Ol%C3%A1%21%20Vim%20pela%20p%C3%A1gina%20de%20Tr%C3%A1fego%20Pago%20e%20quero%20saber%20mais%20sobre%20esse%20servi%C3%A7o." target="_blank" class="btn-primary">Quero mais clientes</a>
      <a href="#plataformas" class="btn-secondary">Ver plataformas</a>
    </div>
  </div>
</section>
...
<div class="plataformas" id="plataformas" aria-label="Plataformas de anúncios gerenciadas pela BagiCo">
  ...
  <div class="plataformas-grid">
    ...
    <div class="plataforma-item reveal">
      ...
      <div class="plataforma-tipo">Sob demanda</div>
    </div>
  </div>
</div>
...
<section class="cta" id="orcamento" aria-label="Solicitar orçamento de tráfego pago">
  ...
  <div class="cta-actions reveal">
    <a href="https://wa.me/5551993535790?text=Ol%C3%A1%21%20Vim%20pela%20p%C3%A1gina%20de%20Tr%C3%A1fego%20Pago%20e%20quero%20saber%20mais%20sobre%20esse%20servi%C3%A7o." target="_blank" class="btn-primary">Falar no WhatsApp</a>
